...
[IMPORTANT]
====
Switch to the Terminal window for this section, as any long-running commands will persist via its `tmux` session, in case you get temporarily disconnected.
====
