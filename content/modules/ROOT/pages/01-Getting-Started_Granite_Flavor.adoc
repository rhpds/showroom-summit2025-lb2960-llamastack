...
[source,sh,role=execute]
----
ollama pull rjmalagon/granite3.2:8b-instruct-bf16
----
+
...
[source,textinfo]
----
[dev@dev ~]$ ollama pull rjmalagon/granite3.2:8b-instruct-bf16
> 
pulling manifest 
...
. Running `ollama run rjmalagon/granite3.2:8b-instruct-bf16` command will let us interact with our LLM on the command line, the `--keepalive 90m` will make sure the model stays loaded, this is important for us as we plan to use this model throughout the lab.
+

[source,sh,role=execute]
----
ollama run granite3.2:8b-instruct-bf16 --keepalive 90m
----
+
...
[source,sh,role=execute]
----
export LLAMA_STACK_MODEL="granite3.2:8b-instruct-bf16"                  <1>
export LLAMA_STACK_PORT=8322                                               <2>
...
export CONTAINER_NAME="llamastack-ollama-granit3b-8b-instruct"             <5> 
...
export LLAMA_STACK_MODEL="granite3-dense:8b"               
export LLAMA_STACK_PORT=8323                                               
export LLAMA_STACK_SERVER=http://localhost:$LLAMA_STACK_PORT            
export LLAMA_SERVER_CONTAINER_IMAGE="llamastack/distribution-ollama:0.2.5" 
export CONTAINER_NAME="llamastack-ollama-granit3b-8b-dense"            
export OLLAMA_PORT=11434    

### with VLLM
export LLAMA_STACK_MODEL="ibm-granite/granite-3.2-8b-instruct"               
export LLAMA_STACK_PORT=8324                                               
export LLAMA_STACK_SERVER=http://localhost:$LLAMA_STACK_PORT            
export LLAMA_SERVER_CONTAINER_IMAGE="llamastack/distribution-remote-vllm" 
export CONTAINER_NAME="llamastack-ollama-granit3b-8b-dense"            
export OLLAMA_PORT=11434 
